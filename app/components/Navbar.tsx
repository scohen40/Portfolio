            ...
            {({open}) => (
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                            ...
                            <div className="flex items-center">
                                <Link href="/">
                                    <h1 className="text-2xl font-medium">
                                        Sarah <span className="text-pink-500">Cohen</span>
                                    </h1>
                                </Link>
                            </div>
                        ...
                        <div className="-mr-2 flex items-center sm:hidden">
                            <Disclosure.Button className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-pink-500 dark:hover:bg-gray-800">
                                {open ?(
                ...
                <Disclosure.Panel className="sm:hidden">
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        {/* <Link href="/guestbook" prefetch className={`${pathname == "/guestbook" ? "bg-pink-50 border-pink-500 text-pink-500 block pl-3 pr-4 py-2 border-l-4 text-base font-medium dark:bg-gray-800" 
                        : "border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-white block pl-3 pr-4 py-2 dark:hover:bg-gray-700 border-l-4 text-base font-medium dark-text-white"
                        } `}>
                            Guestbook
                        </Link> */}
