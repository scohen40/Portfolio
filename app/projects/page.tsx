    ...
    return (
        <div className="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <div className="grid gap-4 sm:grid-cols-2 md:gap-6 lg:grid-col-3 lg:gap-10 pt-8">
                {data.map((project) => (
                    <article key={project._id} className="overflow-hidden dark:border-zinc-600 rounded-lg border border-gray-100 bg-white shadow-lg dark:bg-black dark:shadow-gray-700 shadow-pink-100">
