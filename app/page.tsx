    ...
    <div className="divide-y divide-gray-100 dark:divide-gray-700">
      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        <div className="flex flex-col items-center pt-8">
          <Image alt="Picture of Sarah Cohen" src={Me} className="h-48 w-48 rounded-full object-cover object-top" />
          <h3 className="pt-4 pb-2 text-2cl font-bold leading-8 tracking-tight">Sarah Cohen</h3>
          <p className="text-gray-500 dark:texk-gray-300 text-center">
            Software Engineer
          </p>

          <div className="flex space-x-5 pt-6">
            <a href="https://github.com/scohen40" target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-pink-500 hover:text-pink-600"   
              >
            ...
            <a href="https://www.linkedin.com/in/scohen40/" target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-pink-500 hover:text-pink-600"
            ...
            <a href="mailto:cohen.sarah1996@gmail.com" target="_blank">
            <svg
              viewBox="0 0 1024 1024"
              fill="currentColor"
              className="w-8 h-8 text-pink-500 hover:text-pink-600"
